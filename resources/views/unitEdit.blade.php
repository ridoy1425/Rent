        ...
        <form action="" method="post">
            ...
            <div class="card card-default">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="propertyName" name="propertyName" required>
                                        {{-- @php
                                        $propertyName = APP/Models/
                                        @endphp --}}
                                        <option selected disabled value="">{{ $unit->propertyName }}</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" value="{{ $unit->houseRent }}" class="form-control" id="houseRent" name="houseRent"
                                            required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" value="{{ $unit->deposit }}" class="form-control" id="deposit" name="deposit">
                                    </div>
                                </div>
                                @if($unit->othersBill)
                                @foreach($unit->othersBill as $other)
                                <h6>Others Bill</h6>
                                <div class="row">
                                    <div class="col">
                                        <label for="otherBillName" class="form-label">Bill Name</label>
                                        <input type="text" class="form-control" value="{{ $other['billName']}}" id="otherBillName" name="otherBillName[]">
                                    </div>
                                    <div class="col">
                                        <label for="otherBillAmount" class="form-label">Amount</label>
                                        <input type="text" class="form-control" value="{{ $other['billAmount']}}" id="otherBillAmount" name="otherBillAmount[]">
                                    </div>
                                </div> <br>
                                @endforeach
                                @endif
                ...
                <div class=" mx-auto mb-5">
                    <button class="btn btn-warning" type="submit">Update Unit</button>
                </div>
            </div>
            {{-- card-body end --}}
        </form>
